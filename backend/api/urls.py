...
from .views import CustomTokenObtainPairView, RegisterView, CurrentUserView, ApplicationViewSet, ExplainView, ClientPresetsView, ClientSearchView, ClientFeaturesView, MLModelListView
